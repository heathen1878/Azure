...
$Name = (-Join("1.0-Landing-Zone-Log-Analytics-Storage-",(Get-Date).Day,"-",(Get-Date).Month,"-",(Get-Date).Year,"-",(Get-Date).Hour,(Get-Date).Minute))
...
$Name = (-Join("1.0-Landing-Zone-Log-Analytics-",(Get-Date).Day,"-",(Get-Date).Month,"-",(Get-Date).Year,"-",(Get-Date).Hour,(Get-Date).Minute))
